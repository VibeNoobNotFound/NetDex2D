# IosManualInstaller (updates/installers/IosManualInstaller.cs)

- Source: `scripts/updates/installers/IosManualInstaller.cs`
- Namespace: `NetDex.Updates.Installers`
- Purpose: IosManualInstaller in `updates/installers/IosManualInstaller.cs`. GitHub release updater state machine, checksum verification, and installers.
...
- Source range: `scripts/updates/installers/IosManualInstaller.cs:11`
- Inputs:
